...
def save_pdf_to_disk(pdf_bytes: bytes, filename: str, project_dir: str = PROJECT_DIR) -> str:
    """
    Tenta salvar pdf_bytes em ~/Downloads/<filename>.pdf.
    Se não for possível, salva em project_dir/<filename>.pdf.
    Retorna o caminho absoluto do arquivo salvo ou '' em caso de falha.
    """
    try:
